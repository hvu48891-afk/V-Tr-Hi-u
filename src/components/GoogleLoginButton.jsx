...
export default function GoogleLoginButton() {
  ...
  return (
    <div className="flex justify-center w-full mt-4">
      <button
        onClick={() => login()}
        className="w-full py-3 rounded-2xl border-2 border-surface-container-high text-primary text-sm font-bold hover:bg-surface-container-low transition-all flex items-center justify-center gap-3"
      >
